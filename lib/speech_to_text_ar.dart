...
void main() {
  runApp(UploadAudioPage_ar());
}

const int blue = 0xFF090088;
const int beige = 0xFFF1F7B5;

class UploadAudioPage_ar extends StatefulWidget {
  @override
  _UploadAudioPageState createState() => _UploadAudioPageState();
}

class _UploadAudioPageState extends State<UploadAudioPage_ar> {
  File? _audioFile;
              ...
              children: [
                ...
                Container(
                  ...
                  child: SizedBox(
                    ...
                    width: double.infinity,
                    child: Text(
                      'استخراج النص من ملف صوتي باللغةالعربية، يدعم فقط .wav',
                      textAlign: TextAlign.center,
                      style: GoogleFonts.notoKufiArabic(
                        fontSize: 28,
                        fontWeight: FontWeight.bold,
