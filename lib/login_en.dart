...
class LoginPage_en extends StatefulWidget {
  @override
  _LoginPageState createState() => _LoginPageState();
}

class _LoginPageState extends State<LoginPage_en> {
  ...
  Future<void> userLogin() async {
    ...
    if (loginSuccess) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => inputmethods(userId: userId),
        ),
      );
    } else {
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text(
              ...
              style: TextStyle(fontSize: 24, color: Color(blue)),
            ),
            actions: <Widget>[
              ElevatedButton(
                child: Text(
