...
class ScannerPage_en extends StatefulWidget {
  @override
  _ScannerPageState createState() => _ScannerPageState();
}

class _ScannerPageState extends State<ScannerPage_en> {
              ...
              child: Center(
                child: ElevatedButton.icon(
                  ...
                  icon: SizedBox(
                    ...
                    width: 50,
                    child:
                        Icon(Icons.camera_alt, color: Color(beige), size: 32),
                  ),
                  label: Text(
                    'Take a photo',
                      ...
                      ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  PreviewPage_en(image: snapshot.data!),
                            ),
                          );
                        },
                        child: Text(
